...
#include "../../FlightWar/scoreboard.h"
...
QT_MOC_LITERAL(4, 25, 16), // "on_retry_clicked"
QT_MOC_LITERAL(5, 42, 13) // "on_ok_clicked"

    },
    "Scoreboard\0exit\0\0restart\0on_retry_clicked\0"
    "on_ok_clicked"
};
...
void Scoreboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Scoreboard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scoreboard::exit)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Scoreboard::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scoreboard::restart)) {
                *result = 1;
                return;
            }
        }
